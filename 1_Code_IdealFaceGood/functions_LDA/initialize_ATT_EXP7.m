function [trn , trnGroup , labels , testing2] = initialize_ATT_EXP7(counter, XP, YP, path_of_warped_faces, crop_faces_row1, crop_faces_row2, crop_faces_column1, crop_faces_column2)
