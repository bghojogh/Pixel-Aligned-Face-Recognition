function [ answer , LDAEgn , egnValSort , varargout] = myLDA_Yale_EXP1( testing , trn , trnGroup , varargin ) %  trn: each row is an observation, trnGroup: nominal or double
