function [trn , trnGroup , labels , testing2] = initialize_Yale_EXP2(counter, XP, YP, path_of_eye_aligned_faces, crop_faces_row1, crop_faces_row2, crop_faces_column1, crop_faces_column2)
