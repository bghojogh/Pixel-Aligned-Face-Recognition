function [ answer , LDAEgn , egnValSort , varargout] = myLDA_Yale_EXP4( testing , trn , trnGroup , varargin ) %  trn: each row is an observation, trnGroup: nominal or double
