...
%         [answer , LDAEgn, egnValSort , LDAftrTest]=myLDA_Yale_EXP1 ( testing , test , testGroup , 'test', {test} , 'needPCA', 1 );
...
%             [answer , LDAEgn, egnValSort , LDAftrTest] = myLDA_Yale_EXP3 ( testing , test , testGroup , 'test', {gallery} , 'needPCA', 1 );
% 
...
%         [answer , LDAEgn, egnValSort , LDAftrTest]=myLDA_ATT_EXP1 ( testing , test , testGroup , 'test', {test} , 'needPCA', 1 );
...
%             [answer , LDAEgn, egnValSort , LDAftrTest]=myLDA_ATT_EXP3 ( testing , test , testGroup , 'test', {gallery} , 'needPCA', 1 );
